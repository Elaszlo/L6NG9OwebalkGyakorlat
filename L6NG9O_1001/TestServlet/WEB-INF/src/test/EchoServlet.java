...
public class EchoServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("<body><h2>A megadott adatai</h2>");
         ...
         if (username == null
            ...
            out.println("<p>Nev: HIANYZIK</p>");
         } else {
            out.println("<p>Nev: " + username + "</p>");
         }
         ...
         // Get null if the parameter is missing from query string.
         if (gender == null) {
            out.println("<p>Neme: HIANYZIK</p>");
         } else if (gender.equals("m")) {
            out.println("<p>Neme: ferfi</p>");
         } else {
         ...
         if (age == null) {
            out.println("<p>Kor: HIANYZIK</p>");
         } else if (age.equals("1")) {
            out.println("<p>Kor: &lt; 1 evesnel</p>");
         } else if (age.equals("99")) {
            out.println("<p>Kor: 1 evestol 99 evesig</p>");
         } else {
            out.println("<p>Kor: &gt; 99 evesnel</p>");
         }
         ...
         if (instruction == null
            ...
            out.println("<p>Megjegyzes: SEMMI</p>");
         } else {
            out.println("<p>Megjegyzes: " + instruction + "</p>");
         }
